...
Public Class Rpt_Cotizaciones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrecisaFrozen.Win.Rpt_Cotizaciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Cotizaciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Cotizaciones = New Rpt_Cotizaciones()
        rpt.Site = Me.Site
        Return rpt
    End Function
