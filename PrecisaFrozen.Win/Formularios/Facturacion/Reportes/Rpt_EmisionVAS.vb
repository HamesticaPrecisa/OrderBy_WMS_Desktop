...
Public Class Rpt_EmisionVAS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrecisaFrozen.Win.Rpt_EmisionVAS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_EmisionVAS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_EmisionVAS = New Rpt_EmisionVAS()
        rpt.Site = Me.Site
        Return rpt
    End Function
