Public Class Lst_AyudaContratos
    ...
    Private Sub Lst_AyudaContratos_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        DataGridView1.DataSource = fnc.ListarTablasSQL("SELECT cont_codi,cont_descr,estado=case when cont_estado='0' then 'ACTIVO' else 'INACTIVO' end FROM contrato " + condicion + " order by cont_estado,cont_descr asc")
    End Sub
