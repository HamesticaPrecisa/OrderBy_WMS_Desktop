...
Public Class FrmFotosServicios

    Private Sub FrmFotosServicios_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        TraeImagenes()
    End Sub
...
#Region "Funciones"
    ...
    Sub GrabaImagen(ByVal guia As String, ByVal foto As Byte(), ByVal num As Integer, ByVal foto2 As String)
        Dim sql9 = "DELETE FROM serimagen WHERE rimg_rececodi = '" + guia + "' AND rimg_num = " + num.ToString()
        fnc.MovimientoSQL(sql9)

        Dim con As New SqlConnection
        Dim query As String = "INSERT INTO serimagen(rimg_imagen,rimg_rececodi,rimg_num,rimg_imagen2) VALUES(@foto,@guia,@num,Convert(Varbinary(max),Convert(varchar(MAX),@foto2)))"
    ...
    Sub TraeImagenes()
        Dim sql As String = "SELECT rimg_imagen,rimg_num FROM serimagen WHERE rimg_rececodi= '" + Frm_ServiciosREC.lblrece.Text + "'"
...
#End Region
    ...
    Private Sub PictureBox3_MouseHover(sender As System.Object, e As System.EventArgs) Handles PictureBox3.MouseHover
        PictureBox5.SizeMode = PictureBoxSizeMode.StretchImage
