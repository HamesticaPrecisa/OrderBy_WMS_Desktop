...
#Region "Funciones"
    ...
    Sub GrabaImagen(ByVal guia As String, ByVal foto As Byte(), ByVal num As Integer, ByVal foto2 As String)
        Dim sql9 = "DELETE FROM receimagen WHERE rimg_rececodi = '" + guia + "' AND rimg_num = " + num.ToString()
    ...
    Sub TraeImagenes()
        Dim sql As String = "SELECT rimg_imagen,rimg_num FROM receimagen WHERE rimg_rececodi= '" + Frm_GuiaRecepcionAgregar.TxtCodRece.Text + "'"
...
#Region "Eventos"
    ...
    Private Sub Frm_AdjuntaFotoRecepcion_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        TraeImagenes()
    End Sub
