...
Public Class Frm_GuiaPreDespachoAgregar
    ...
    Private Sub BtnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnGuardar.Click
        ...
        Try
            ...
            ElseIf resp < 4 Then
                MsgBox("Error inesperado al grabar la información: " + lastSqlError, MsgBoxStyle.Critical, "Aviso")
            ElseIf resp = 4 Then
                MsgBox("El Pre-despacho ya esta grabado", MsgBoxStyle.Information, "Aviso")
            Else
                MsgBox("Error inesperado al grabar la información: " + lastSqlError, MsgBoxStyle.Critical, "Aviso")
            ...
            If e.KeyChar = ChrW(13) Then
                ...
                Else
                    ...
                    If TxtNped.Text = "1" Then
                        Dim sqlp As String = "SELECT  pallet, Sum(cajas) as cajas from vg_pedidosactivos WHERE pallet='" + pallet10 + "' group by pallet"
                        Dim tablap As DataTable = fnc.ListarTablasSQL(sqlp)


                        If tablap.Rows.Count > 0 Then

                            Dim sqlp2 As String = "select racd_codi, racd_unidades from rackdeta where racd_codi='" + pallet10 + "' "
                            Dim tablap2 As DataTable = fnc.ListarTablasSQL(sqlp2)

                            If tablap.Rows(0)(1).ToString() = tablap2.Rows(0)(1).ToString() Then
            ...
            If tabla.Rows(0)(0).ToString() = "0" Then
                ...
                Else
                    If MsgBox("Seguro de anular la guia ", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Aviso") = vbYes Then
                        ...
                        Catch ex As Exception
                            MsgBox("Error inesperado al grabar la información: " + ex.Message, MsgBoxStyle.Critical, "Aviso")
                        End Try
    ...
    Private Sub TxtNped_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtNped.TextChanged
    ...
    Private Sub Temp1_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Temp1.TextChanged
        calcTempProm()
    End Sub

    Private Sub Temp2_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Temp2.TextChanged
        calcTempProm()
    End Sub

    Private Sub Temp3_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Temp3.TextChanged
        calcTempProm()
    End Sub
