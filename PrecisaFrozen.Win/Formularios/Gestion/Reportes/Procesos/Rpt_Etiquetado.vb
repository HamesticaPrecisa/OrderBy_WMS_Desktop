...
Public Class Rpt_Etiquetado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrecisaFrozen.Win.Rpt_Etiquetado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Etiquetado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Etiquetado = New Rpt_Etiquetado()
        rpt.Site = Me.Site
        Return rpt
    End Function
