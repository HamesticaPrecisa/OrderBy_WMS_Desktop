...
Public Class RptContenedores
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrecisaFrozen.Win.RptContenedores.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptContenedores
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptContenedores = New RptContenedores()
        rpt.Site = Me.Site
        Return rpt
    End Function
