...
Public Class RptImportaciones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrecisaFrozen.Win.RptImportaciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptImportaciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptImportaciones = New RptImportaciones()
        rpt.Site = Me.Site
        Return rpt
    End Function
