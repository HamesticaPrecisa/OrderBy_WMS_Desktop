...
Public Class Rpt_StockResumido
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrecisaFrozen.Win.Rpt_StockResumido.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_StockResumido
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_StockResumido = New Rpt_StockResumido()
        rpt.Site = Me.Site
        Return rpt
    End Function
