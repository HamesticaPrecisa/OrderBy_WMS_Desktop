...
Public Class Rpt_ResumidoFecha
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrecisaFrozen.Win.Rpt_ResumidoFecha.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_ResumidoFecha
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_ResumidoFecha = New Rpt_ResumidoFecha()
        rpt.Site = Me.Site
        Return rpt
    End Function
