...
Public Class Rpt_StockAcumulado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrecisaFrozen.Win.Rpt_StockAcumulado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_StockAcumulado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_StockAcumulado = New Rpt_StockAcumulado()
        rpt.Site = Me.Site
        Return rpt
    End Function
