...
Public Class Rpt_AnormalFrigo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrecisaFrozen.Win.Rpt_AnormalFrigo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_AnormalFrigo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_AnormalFrigo = New Rpt_AnormalFrigo()
        rpt.Site = Me.Site
        Return rpt
    End Function
