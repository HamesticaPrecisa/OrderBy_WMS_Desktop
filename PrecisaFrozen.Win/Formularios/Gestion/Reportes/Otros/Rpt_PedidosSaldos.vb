...
Public Class Rpt_PedidosSaldos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrecisaFrozen.Win.Rpt_PedidosSaldos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_PedidosSaldos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_PedidosSaldos = New Rpt_PedidosSaldos()
        rpt.Site = Me.Site
        Return rpt
    End Function
