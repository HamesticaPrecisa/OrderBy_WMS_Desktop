...
Public Class Rpt_PosicionesLibres
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_PosicionesLibres.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrecisaFrozen.Win.Rpt_PosicionesLibres.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_where() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRpt_PosicionesLibres
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_PosicionesLibres = New Rpt_PosicionesLibres()
        rpt.Site = Me.Site
        Return rpt
    End Function
