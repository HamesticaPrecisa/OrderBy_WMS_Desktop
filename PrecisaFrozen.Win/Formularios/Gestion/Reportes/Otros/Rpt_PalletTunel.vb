...
Public Class Rpt_PalletTunel
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrecisaFrozen.Win.Rpt_PalletTunel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_PalletTunel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_PalletTunel = New Rpt_PalletTunel()
        rpt.Site = Me.Site
        Return rpt
    End Function
