...
Public Class Rpt_PalletVencidos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrecisaFrozen.Win.Rpt_PalletVencidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_PalletVencidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_PalletVencidos = New Rpt_PalletVencidos()
        rpt.Site = Me.Site
        Return rpt
    End Function
