...
Public Class Rpt_EnvioCorreos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrecisaFrozen.Win.Rpt_EnvioCorreos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_EnvioCorreos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_EnvioCorreos = New Rpt_EnvioCorreos()
        rpt.Site = Me.Site
        Return rpt
    End Function
