...
Public Class Rpt_Posiciones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrecisaFrozen.Win.Rpt_Posiciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Posiciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Posiciones = New Rpt_Posiciones()
        rpt.Site = Me.Site
        Return rpt
    End Function
