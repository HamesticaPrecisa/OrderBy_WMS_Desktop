...
Public Class Rpt_GuiaRecepcion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrecisaFrozen.Win.Rpt_GuiaRecepcion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_GuiaRecepcion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_GuiaRecepcion = New Rpt_GuiaRecepcion()
        rpt.Site = Me.Site
        Return rpt
    End Function
