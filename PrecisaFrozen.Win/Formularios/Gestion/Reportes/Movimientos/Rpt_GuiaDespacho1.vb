...
Public Class Rpt_GuiaDespacho
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrecisaFrozen.Win.Rpt_GuiaDespacho.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_GuiaDespacho
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_GuiaDespacho = New Rpt_GuiaDespacho()
        rpt.Site = Me.Site
        Return rpt
    End Function
