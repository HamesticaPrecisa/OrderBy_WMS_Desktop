...
Public Class Rpt_GuiaPrecisa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrecisaFrozen.Win.Rpt_GuiaPrecisa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_GuiaPrecisa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_GuiaPrecisa = New Rpt_GuiaPrecisa()
        rpt.Site = Me.Site
        Return rpt
    End Function
