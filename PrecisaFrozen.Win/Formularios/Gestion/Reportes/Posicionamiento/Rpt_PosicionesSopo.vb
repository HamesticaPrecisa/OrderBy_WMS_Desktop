...
Public Class Rpt_PosicionesSopo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrecisaFrozen.Win.Rpt_PosicionesSopo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_PosicionesSopo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_PosicionesSopo = New Rpt_PosicionesSopo()
        rpt.Site = Me.Site
        Return rpt
    End Function
