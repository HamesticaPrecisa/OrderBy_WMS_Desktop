...
Public Class AgrosuperDes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrecisaFrozen.Win.AgrosuperDes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAgrosuperDes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AgrosuperDes = New AgrosuperDes()
        rpt.Site = Me.Site
        Return rpt
    End Function
