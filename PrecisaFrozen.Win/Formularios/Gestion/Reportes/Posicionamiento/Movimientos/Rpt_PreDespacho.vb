...
Public Class Rpt_PreDespacho
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrecisaFrozen.Win.Rpt_PreDespacho.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_PreDespacho
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_PreDespacho = New Rpt_PreDespacho()
        rpt.Site = Me.Site
        Return rpt
    End Function
