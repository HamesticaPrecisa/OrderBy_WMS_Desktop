...
Public Class Rpt_GuiasPendTunel
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrecisaFrozen.Win.Rpt_GuiasPendTunel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_GuiasPendTunel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_GuiasPendTunel = New Rpt_GuiasPendTunel()
        rpt.Site = Me.Site
        Return rpt
    End Function
