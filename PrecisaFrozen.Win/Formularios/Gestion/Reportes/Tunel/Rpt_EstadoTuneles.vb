...
Public Class Rpt_EstadoTuneles
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrecisaFrozen.Win.Rpt_EstadoTuneles.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_EstadoTuneles
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_EstadoTuneles = New Rpt_EstadoTuneles()
        rpt.Site = Me.Site
        Return rpt
    End Function
